...
const TRANSLATIONS = {
  ...
  en: {
    ...
    s_key_collection:  'At the Gate — Access with Code',
    ...
    step3_title:       'You are at the Villa Gate',
    step3_p:           'After Hotel Oasi\'s large wall, the <b>villa gate</b> is on your left. Pull into the driveway to enter the code that will open the gate.',
    step3_p_serena:    'After Hotel Oasi\'s large wall, the <b>villa gate</b> is on your left. Pull into the driveway to enter the code that will open the gate.',

    key_find:          'Your villa is open with the keys on the table',
    key_find_excl:     'Your villa is open with the keys on the table',
    key_label:         'CODICE PER APRIRE IL CANCELLO',
    key_take:          'Take',
    key_note_serena:   'You have arrived in front of the Gate of Villa Serena. On the wall to your <b>left</b> you will find the keypad where you enter the code to open the gate. Go in — your villa is open with the keys on the kitchen table.<br><br>When you wish to leave, simply drive towards the gate and it will open automatically.',
    key_note_serenella:'You have arrived in front of the Gate of Villa Serena. On the wall to your <b>left</b> you will find the keypad where you enter the code to open the gate. Go in — your villa is open with the keys on the kitchen table.<br><br>When you wish to leave, simply drive towards the gate and it will open automatically.',
    key_note_fontanella:'You have arrived in front of the Gate of Villa Serena. On the wall to your <b>left</b> you will find the keypad where you enter the code to open the gate. Go in — your villa is open with the keys on the kitchen table.<br><br>When you wish to leave, simply drive towards the gate and it will open automatically.',
    key_note_excl:     'You have arrived in front of the Gate of Villa Serena. On the wall to your <b>left</b> you will find the keypad where you enter the code to open the gate. Go in — your villa is open with the keys on the kitchen table.<br><br>When you wish to leave, simply drive towards the gate and it will open automatically.',
    ...
    gk_bbq_p:          'In the villa garden there are barbecues available for your use — enjoy your grilling.',

    highlight_emerg:   'We are available daily from <b>7am to 7pm</b> for any assistance.<br>For emergencies outside these hours, contact the emergency numbers',
    ...
    waste_d1:          'Please follow the waste disposal instructions provided inside your villa.',
    ...
    coffee_d2:         'These professional capsules are <u><b>NOT AVAILABLE IN REGULAR SUPERMARKETS.</b></u>',
  ...
  it: {
    ...
    s_key_collection:  'Al Cancello — Accesso con codice',
    ...
    step3_title:       "Siete al Cancello della villa",
    step3_p:           "Dopo il grande muro dell'Hotel Oasi, il cancello della villa è alla tua sinistra. Accosta nel vialetto per inserire il codice che aprirá il cancello.",
    step3_p_serena:    "Dopo il grande muro dell'Hotel Oasi, il cancello della villa è alla tua sinistra. Accosta nel vialetto per inserire il codice che aprirá il cancello.",

    key_find:          'La tua villa é aperta con le chiavi nel tavolo',
    key_find_excl:     'Le ville sono aperte con le chiavi nel tavolo',
    key_label:         'CODICE PER APRIRE IL CANCELLO',
    key_take:          'Prendi',
    key_note_serena:   "Sei arrivato davanti al Cancello di Villa Serena, nel muro alla tua <b>sinistra</b> troverai il tastierino dove inserire il codice che aprirà il cancello. Accedi, la tua villa è aperta con le chiavi nel tavolo di cucina.<br><br>Quando vorrai uscire dalla villa sarà sufficiente avvicinarsi con la macchina verso il cancello che si aprirà automaticamente.",
    key_note_serenella:"Sei arrivato davanti al Cancello di Villa Serena, nel muro alla tua <b>sinistra</b> troverai il tastierino dove inserire il codice che aprirà il cancello. Accedi, la tua villa è aperta con le chiavi nel tavolo di cucina.<br><br>Quando vorrai uscire dalla villa sarà sufficiente avvicinarsi con la macchina verso il cancello che si aprirà automaticamente.",
    key_note_fontanella:"Sei arrivato davanti al Cancello di Villa Serena, nel muro alla tua <b>sinistra</b> troverai il tastierino dove inserire il codice che aprirà il cancello. Accedi, la tua villa è aperta con le chiavi nel tavolo di cucina.<br><br>Quando vorrai uscire dalla villa sarà sufficiente avvicinarsi con la macchina verso il cancello che si aprirà automaticamente.",
    key_note_excl:     "Sei arrivato davanti al Cancello di Villa Serena, nel muro alla tua <b>sinistra</b> troverai il tastierino dove inserire il codice che aprirà il cancello. Accedi, la tua villa è aperta con le chiavi nel tavolo di cucina.<br><br>Quando vorrai uscire dalla villa sarà sufficiente avvicinarsi con la macchina verso il cancello che si aprirà automaticamente.",
    ...
    gk_bbq_title:      'Barbecue',
    gk_bbq_p:          'Nel giardino della villa sono presenti dei Barbecue, puoi usarli per fare le tue grigliate.',

    highlight_emerg:   'Siamo disponibili tutti i giorni dalle <b>7:00 alle 19:00</b> per qualsiasi necessità.<br>Per emergenze fuori da questi orari, contatta i numeri di emergenza',
    ...
    waste_d1:          "Segui le istruzioni per la raccolta differenziata fornite all'interno della tua villa",
    ...
    coffee_d2:         'Le capsule di questa macchina professionale <u><b>NON SI TROVANO NEI NORMALI SUPERMERCATI.</b></u>',
