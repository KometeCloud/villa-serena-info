...
const TRANSLATIONS = {
  ...
  en: {
    ...
    s_exp:             '🌿 Experiences & Activities',
    exp_intro:         'Discover the best of Tuscany with our partner.',
    exp_discount:      'Exclusive Guest Discount',
    exp_desc:          'As a guest of Villa Serena, you enjoy a special discount with <b>EBK Luxury Experience</b> — curated tours, tastings, and unforgettable Tuscan adventures.',
    exp_code_lbl:      'Use this code when booking:',
    exp_code_note:     'Visit <b>ebkexperience.com</b> to explore available experiences',
  ...
  it: {
    ...
    s_exp:             '🌿 Esperienze & Attività',
    exp_intro:         'Scopri il meglio della Toscana con il nostro partner.',
    exp_discount:      'Sconto Esclusivo per Ospiti',
    exp_desc:          'Come ospite di Villa Serena, hai uno sconto speciale con <b>EBK Luxury Experience</b> — tour curati, degustazioni e avventure toscane indimenticabili.',
    exp_code_lbl:      'Usa questo codice al momento della prenotazione:',
    exp_code_note:     'Visita <b>ebkexperience.com</b> per scoprire le esperienze disponibili',
